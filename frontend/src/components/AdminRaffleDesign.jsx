          ...
          <div className="flex-1 min-w-0 space-y-6 max-w-2xl">
            ...
            <div className="bg-white dark:bg-zinc-900 p-6 rounded-3xl border border-zinc-200 dark:border-zinc-800 shadow-sm">
              ...
              {imagePreview ? (
                ...
                <label className="flex flex-col items-center justify-center gap-2 h-48 rounded-2xl border-2 border-dashed border-zinc-200 dark:border-zinc-800 text-zinc-400 cursor-pointer hover:border-lime-400 hover:text-lime-500 transition-colors">
                  <ImagePlus size={26} />
            ...
            <div className="flex items-center gap-3">
              <button
                onClick={handleSave}
                disabled={saving}
                className="px-5 py-2.5 bg-lime-600 text-white font-bold rounded-xl hover:bg-lime-700 shadow-lg shadow-lime-500/30 transition-all active:scale-95 disabled:opacity-50"
              >
