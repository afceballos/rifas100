...
try {
    // Datos de la rifa
    $stmtRaffle = $pdo->prepare("SELECT id, slug, title, description, background_image, payment_info, organizer_name, organizer_photo, theme_color, number_style, price_per_ticket, draw_date, total_tickets, is_published FROM raffles WHERE id = ?");
