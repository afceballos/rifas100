...
try {
    // Datos de la rifa
    $stmtRaffle = $pdo->prepare("SELECT id, title, description, background_image, payment_info, organizer_name, organizer_photo, price_per_ticket, draw_date, total_tickets, is_published FROM raffles WHERE id = ?");
